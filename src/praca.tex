% Można zmienić na angielski wybierając drugą linię
...
% --- < bibliografia > ---
%
% Dla TeXstudio warto przeczytać poniższe!
...
% Dodatkowe paczki do tabel, można usunąć
\usepackage{array}
\usepackage{tabularx}
\usepackage{multirow}
\usepackage{booktabs}
...
\author{Karol Kocierz}
\shortauthor{K. Kocierz}

\titlePL{Przewidywanie przestępstw na podstawie danych historycznych i aktualnych}
% \titleEN{TitleEN}
...
\begin{center}
    ...
    \vspace{13ex}
    % --------------------------- IMIE I NAZWISKO -------------------------------
    {\bf\LARGE\textsf{Karol Kocierz}}\\
    \vspace{3ex}
    {\sf \normalsize kierunek studiów:} {\bf\normalsize\textsf{Informatyka Stosowana}}\\
    \vspace{15ex}
    %% ------------------------ TYTUL PRACY --------------------------------------
    {\bf\Huge\textsf{Przewidywanie przestępstw na podstawie danych historycznych i aktualnych}}\\
    \vspace{14ex}
    %% ------------------------ OPIEKUN PRACY ------------------------------------
    {\sf \LARGE Opiekun:} {\bf\LARGE\textsf{Dr. Piotr Kowalski}}\\
    \vspace{22ex}
